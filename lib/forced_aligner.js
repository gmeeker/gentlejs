...
class ForcedAligner {
  ...
  async transcribe(wavfile, o = {}) {
    ...
    const genHclgFilename = await makeBigramLanguageModel(ks, resources.protoLangDir, options);
    ...
    words = realign(wavfile, words, this.ms, this.resources, this.nthreads, progress);
